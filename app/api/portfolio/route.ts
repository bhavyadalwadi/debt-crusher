...
function normalizePortfolioInput(portfolio: PortfolioState): PortfolioState {
  return {
    ...portfolio,
    setup: {
...
async function loadPortfolioBundle() {
...
export async function POST(request: Request) {
  try {
    ...
    const normalizedPortfolio = normalizePortfolioInput(body.portfolio);
    ...
    const baseSnapshot = buildActivitySnapshot(normalizedPortfolio, body.source, {
      label: body.label,
